              ...
              <div className="flex flex-col gap-5">
                <div className="flex justify-center gap">
                  <button className="flex flex-col">
                    <h3 className="text-white mr-5 cursor-pointer" id="envoyer" onClick={()=>scrollToDiv("envoyer")}>Envoyer</h3>
                    <div className=" h-[5px] bg-blue"></div>
                  </button>
                  <button className="flex flex-col">
                    <h3 className="recevoir cursor-pointer" id="recevoir" onClick={()=>scrollToDiv(".recevoir")}>Recevoir</h3>
                ...
                <div className="flex gap-10 w-[1000px] overflow-x-auto">
                  ...
                  <p style={{justifySelf:"end",textAlign:"center"}} className="font-semibold">Envoyez de l'argent a la vitesse de la lumiere</p>

                  <button className="font-bold border-3 rounded-full w-[50%] py-2 self-center">Envoyez de l'argent</button>
                ...
                <div className=" flex flex-col justify-center rounded-b-2xl w-[80%] pb-5 overflow-hidden gap-6 bg-blue-400">
                  ...
                  <p style={{justifySelf:"end",textAlign:"center"}} className="font-semibold">Soyez remboursé de manière sécurisée.
</p>

                  <button className="font-bold border-3 rounded-full w-[50%] py-2 self-center">Demander de l'argent</button>
